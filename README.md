[![Java CI with Gradle](https://github.com/Katkutia/PageObject_HW/actions/workflows/gradle.yml/badge.svg)](https://github.com/Katkutia/PageObject_HW/actions/workflows/gradle.yml)
