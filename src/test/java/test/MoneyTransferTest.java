...
import static ru.netology.web.test.pages.data.DataHelper.*;
...
class MoneyTransferTest {
    ...
    void setup() {
        ...
        dashboardPage = verificationPage.notify(verificationCode);
    ...
    private Object generateInValidAmount(int secondCardBalance) {
        return null;
    }
}